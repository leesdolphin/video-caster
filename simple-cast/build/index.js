...
/***/ function(module, exports, __webpack_require__) {
	...
	var media = _interopRequireWildcard(_index);
	
	var _redux = __webpack_require__(173);
	
	var _reactReduxChromecastSender = __webpack_require__(195);
	...
	function entrypoint(domElm) {
	  ...
	  ), (0, _reactReduxChromecastSender.castMediaManager)(), (0, _reduxLogger2.default)({ duration: true }), media.episode_middleware()];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadingSpinner = __webpack_require__(193);
	
	var _EpisodeInputBox = __webpack_require__(201);
	  ...
	  render: function render() {
	    if (this.props.media_available) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_LoadingSpinner.LoadingSpinner, null),
	        _react2.default.createElement('br', null),
	        _react2.default.createElement(_EpisodeInputBox.EpisodeInputBox, null)
	      );
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlaybackScrobber = __webpack_require__(190);
	
	var _PlaybackButton = __webpack_require__(191);
	
	var _PlaybackTime = __webpack_require__(192);
...
/***/ function(module, exports) {
	...
	*/
	...
	var DISCOVERING = exports.DISCOVERING = 'chromecast.discover.running';
	var DISCOVERY_ERROR = exports.DISCOVERY_ERROR = 'chromecast.discover.error';
	
	var RECEIVER_AVAILABLE = exports.RECEIVER_AVAILABLE = 'chromecast.receiver.available';
	var RECEIVER_UNAVAILABLE = exports.RECEIVER_UNAVAILABLE = 'chromecast.receiver.unavailable';
	
	var SESSION_CONNECT = exports.SESSION_CONNECT = 'chromecast.session.connect';
	var SESSION_CONNECTING = exports.SESSION_CONNECTING = 'chromecast.session.connecting';
	var SESSION_CONNECTED = exports.SESSION_CONNECTED = 'chromecast.session.connected';
	var SESSION_DISCONNECT = exports.SESSION_DISCONNECT = 'chromecast.session.disconnect';
	var SESSION_DISCONNECTING = exports.SESSION_DISCONNECTING = 'chromecast.session.disconnecting';
	var SESSION_DISCONNECTED = exports.SESSION_DISCONNECTED = 'chromecast.session.disconnected';
	var SESSION_ERROR = exports.SESSION_ERROR = 'chromecast.session.error';
	
	var MSG_SEND = exports.MSG_SEND = 'chromecast.msg.send';
	var MSG_SENDING = exports.MSG_SENDING = 'chromecast.msg.sending';
	var MSG_SENT = exports.MSG_SENT = 'chromecast.msg.sent';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingSpinner = exports.LoadingSpinner = _react2.default.createClass({
	  ...
	  render: function render() {
	    var bars = [];
	    var dim = this.props.width || 32;
	    var spinnerBarStyles = {
	    ...
	    for (var i = 0; i < 12; i++) {
	      var barStyle = Object.assign({}, spinnerBarStyles);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EPISODE_LOAD_SUCCEEDED = exports.EPISODE_LOAD_FAILED = exports.EPISODE_LOAD_STARTED = exports.REQUEST_EPISODE = undefined;
	exports.requestPosts = requestPosts;
	exports.episode_middleware = episode_middleware;
	
	var _episodeLoader = __webpack_require__(202);
	
	var REQUEST_EPISODE = exports.REQUEST_EPISODE = 'kiss.media.request_episode';
	var EPISODE_LOAD_STARTED = exports.EPISODE_LOAD_STARTED = 'kiss.media.episode.load.start';
	var EPISODE_LOAD_FAILED = exports.EPISODE_LOAD_FAILED = 'kiss.media.episode.load.fail';
	var EPISODE_LOAD_SUCCEEDED = exports.EPISODE_LOAD_SUCCEEDED = 'kiss.media.episode.load.success';
	
	function requestPosts(episode_url) {
	  return {
	    ...
	    return function (next) {
	      return function (action) {
	        if (action.type === REQUEST_EPISODE) {
	          (function () {
	            var episode_url = action.episode_url;
	            (0, _episodeLoader.loadEpisode)(episode_url).then(function (episode_data) {
	              dispatch({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiListener = __webpack_require__(198);
	
	var _discover = __webpack_require__(199);
	...
	*/
	...
	function castSender(appId, namespace, discoveryConfig) {
	  var autoDiscover = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
	  ...
	  return function (_ref) {
	    ...
	    (0, _apiListener.apiListener)(function () {
	      apiAvailable = true;
	
	      // notify of api available, not super useful but hey..
	      dispatch({ type: _constants.API_AVAILABLE });
	    ...
	    function sessionListener(session) {
	      ...
	      dispatch({
	        type: _constants.SESSION_CONNECTED,
	        session: session });
	    ...
	    function receiverListener(event) {
	      switch (event) {
	        case chrome.cast.ReceiverAvailability.AVAILABLE:
	          dispatch({ type: _constants.RECEIVER_AVAILABLE });
	          break;
	        case chrome.cast.ReceiverAvailability.UNAVAILABLE:
	          dispatch({ type: _constants.RECEIVER_UNAVAILABLE });
	          setTimeout(function () {
	            dispatch({ type: _constants.DISCOVER_START });
	          }, 1000);
	          break;
	      ...
	      return function (action) {
	        switch (action.type) {
	          case _constants.DISCOVER_START:
	            ...
	            cancelDiscovery = (0, _discover.discover)(appId, sessionListener, receiverListener, config, function () {
	              dispatch({ type: _constants.DISCOVERING });
	            }, function (error) {
	              dispatch({ type: _constants.DISCOVERY_ERROR, error: error });
	            });
	            break;
	          case _constants.DISCOVER_STOP:
	            if (cancelDiscovery) {
	              cancelDiscovery();
	              cancelDiscovery = null;
	            }
	            break;
	          case _constants.SESSION_CONNECT:
	            next({ type: _constants.SESSION_CONNECTING });
	
	            window.chrome.cast.requestSession(sessionListener, function (error) {
	              next({ type: _constants.SESSION_ERROR, error: error });
	            });
	            break;
	          case _constants.SESSION_DISCONNECT:
	            next({ type: _constants.SESSION_DISCONNECTING });
	            activeSession.stop(function () {
	              next({ type: _constants.SESSION_DISCONNECTED });
	            }, function (error) {
	              next({ type: _constants.SESSION_ERROR, error: error });
	            });
	            break;
	          case _constants.MSG_SEND:
	            var payload = action.payload;
	
	
	            (0, _invariant2.default)(!!payload, 'Can not send message without payload');
	
	            if (!activeSession) {
	              next({ type: _constants.MSG_ERROR, error: 'No active session' });
	              return;
	            }
	
	            next({ type: _constants.MSG_SENDING, payload: payload });
	            activeSession.sendMessage(namespace, JSON.stringify(payload), function () {
	              next({ type: _constants.MSG_SENT });
	            }, function (error) {
	              next({ type: _constants.MSG_ERROR, error: error });
	            });
	            break;
	          default:
	            return next(action);
...
/***/ function(module, exports) {
	...
	*/
	...
	function apiListener(onSuccess, onError) {
...
/***/ function(module, exports) {
	...
	*/
	...
	function discover(appId, sessionListener, receiverListener, config, onDiscover, onError) {
	  ...
	  var run = function run() {
	    ...
	    if (!chrome.cast || !chrome.cast.isAvailable) {
	      ...
	      var apiConfig = new chrome.cast.ApiConfig(sessionRequest, sessionListener, receiverListener, config.autoJoinPolicy);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EpisodeInputBox = exports.EpisodeInputBoxView = undefined;
	...
	var EpisodeInputBoxView = exports.EpisodeInputBoxView = _react2.default.createClass({
	  displayName: 'EpisodeInputBoxView',
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onClick: function onClick(episodeUrl) {
	      dispatch((0, _index.requestPosts)(episodeUrl));
	    }
	  };
	};
	
	var EpisodeInputBox = exports.EpisodeInputBox = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(EpisodeInputBoxView);
...
/***/ function(module, exports) {
	...
	function loadSiblingEpisodes(kiss_document) {
	  function imageLink(id) {
	    var arrowImg = kiss_document.getElementById(id);
	    if (arrowImg) {
	      var parent = arrowImg.parentNode;
	...
	function loadEpisode(episodeUrl) {
	  return window.fetch(episodeUrl, {
	    ...
	    return response.text().then(function (response_text) {
	      ...
	      var kiss_document = new window.DOMParser().parseFromString(response_text, 'text/html');
	
	      return Promise.all([{ url: response.url }, loadSiblingEpisodes(kiss_document), loadEpisodeInfo(kiss_document), loadMedia(kiss_document)]);
	    });
	  }).then(function (episodeInformation) {
	    return Object.assign.apply(Object, [{}].concat(_toConsumableArray(episodeInformation)));
	  });
	}
